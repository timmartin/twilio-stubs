...
class ReservationList(ListResource):
    ...
    def stream(self, reservation_status=..., limit: Incomplete | None = ..., page_size: Incomplete | None = ...): ...
    def list(self, reservation_status=..., limit: Incomplete | None = ..., page_size: Incomplete | None = ...): ...
    def page(self, reservation_status=..., page_token=..., page_number=..., page_size=...): ...
