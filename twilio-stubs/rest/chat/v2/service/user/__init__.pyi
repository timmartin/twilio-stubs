...
class UserList(ListResource):
    ...
    def create(self, identity, role_sid=..., attributes=..., friendly_name=..., x_twilio_webhook_enabled=...): ...
...
class UserContext(InstanceContext):
    ...
    def fetch(self): ...
    def delete(self): ...
    def update(self, role_sid=..., attributes=..., friendly_name=..., x_twilio_webhook_enabled=...): ...
    @property
