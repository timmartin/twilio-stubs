...
class ConversationList(ListResource):
    ...
    def create(self, friendly_name=..., unique_name=..., date_created=..., date_updated=..., messaging_service_sid=..., attributes=..., state=..., timers_inactive=..., timers_closed=..., x_twilio_webhook_enabled=...): ...
