...
class DeliveryReceiptList(ListResource):
    def __init__(self, version, chat_service_sid, conversation_sid, message_sid) -> None: ...
...
class DeliveryReceiptContext(InstanceContext):
    def __init__(self, version, chat_service_sid, conversation_sid, message_sid, sid) -> None: ...
    def fetch(self): ...
...
class DeliveryReceiptInstance(InstanceResource):
    class DeliveryStatus:
        ...
        UNDELIVERED: str
        SENT: str
    def __init__(self, version, payload, chat_service_sid, conversation_sid, message_sid, sid: Incomplete | None = ...) -> None: ...
    @property
