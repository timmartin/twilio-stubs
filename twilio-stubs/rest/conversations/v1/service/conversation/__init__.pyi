...
class ConversationList(ListResource):
    ...
    def create(self, friendly_name: Any = ..., unique_name: Any = ..., attributes: Any = ..., messaging_service_sid: Any = ..., date_created: Any = ..., date_updated: Any = ..., state: Any = ..., timers_inactive: Any = ..., timers_closed: Any = ..., x_twilio_webhook_enabled: Any = ...): ...
