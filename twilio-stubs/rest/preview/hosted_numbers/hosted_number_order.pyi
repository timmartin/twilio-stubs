...
class HostedNumberOrderList(ListResource):
    ...
    def create(self, phone_number, sms_capability, account_sid=..., friendly_name=..., unique_name=..., cc_emails=..., sms_url=..., sms_method=..., sms_fallback_url=..., sms_fallback_method=..., status_callback_url=..., status_callback_method=..., sms_application_sid=..., address_sid=..., email=..., verification_type=..., verification_document_sid=...): ...
    def get(self, sid): ...
