...
class InstalledAddOnExtensionList(ListResource):
    def __init__(self, version: Any, installed_add_on_sid: Any) -> None: ...
...
class InstalledAddOnExtensionContext(InstanceContext):
    def __init__(self, version: Any, installed_add_on_sid: Any, sid: Any) -> None: ...
    def fetch(self): ...
    def update(self, enabled: Any): ...

class InstalledAddOnExtensionInstance(InstanceResource):
    def __init__(self, version: Any, payload: Any, installed_add_on_sid: Any, sid: Optional[Any] = ...) -> None: ...
    @property
    def sid(self): ...
    @property
