...
class InstalledAddOnExtensionList(ListResource):
    def __init__(self, version, installed_add_on_sid) -> None: ...
...
class InstalledAddOnExtensionContext(InstanceContext):
    def __init__(self, version, installed_add_on_sid, sid) -> None: ...
    def fetch(self): ...
    def update(self, enabled): ...

class InstalledAddOnExtensionInstance(InstanceResource):
    def __init__(self, version, payload, installed_add_on_sid, sid: Incomplete | None = ...) -> None: ...
    @property
    def sid(self): ...
    @property
