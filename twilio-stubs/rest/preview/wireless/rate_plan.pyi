...
class RatePlanList(ListResource):
    ...
    def create(self, unique_name: Any = ..., friendly_name: Any = ..., data_enabled: Any = ..., data_limit: Any = ..., data_metering: Any = ..., messaging_enabled: Any = ..., voice_enabled: Any = ..., commands_enabled: Any = ..., national_roaming_enabled: Any = ..., international_roaming: Any = ...): ...
