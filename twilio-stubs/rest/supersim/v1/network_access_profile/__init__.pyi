...
from twilio.rest.supersim.v1.network_access_profile.network_access_profile_network import NetworkAccessProfileNetworkList as NetworkAccessProfileNetworkList
from typing import Any, Optional

class NetworkAccessProfileList(ListResource):
    def __init__(self, version: Any) -> None: ...
    def create(self, unique_name: Any = ..., networks: Any = ...): ...
