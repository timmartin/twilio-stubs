...
class MetricList(ListResource):
    ...
    def stream(self, edge: Any = ..., direction: Any = ..., limit: Optional[Any] = ..., page_size: Optional[Any] = ...): ...
    def list(self, edge: Any = ..., direction: Any = ..., limit: Optional[Any] = ..., page_size: Optional[Any] = ...): ...
    def page(self, edge: Any = ..., direction: Any = ..., page_token: Any = ..., page_number: Any = ..., page_size: Any = ...): ...
