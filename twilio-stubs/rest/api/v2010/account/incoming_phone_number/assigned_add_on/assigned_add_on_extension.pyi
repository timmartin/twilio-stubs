...
class AssignedAddOnExtensionList(ListResource):
    def __init__(self, version, account_sid, resource_sid, assigned_add_on_sid) -> None: ...
...
class AssignedAddOnExtensionContext(InstanceContext):
    def __init__(self, version, account_sid, resource_sid, assigned_add_on_sid, sid) -> None: ...
    def fetch(self): ...

class AssignedAddOnExtensionInstance(InstanceResource):
    def __init__(self, version, payload, account_sid, resource_sid, assigned_add_on_sid, sid: Incomplete | None = ...) -> None: ...
    @property
    def sid(self): ...
    @property
