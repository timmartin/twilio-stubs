...
class TriggerList(ListResource):
    ...
    def create(self, callback_url, trigger_value, usage_category, callback_method=..., friendly_name=..., recurring=..., trigger_by=...): ...
    def stream(self, recurring=..., trigger_by=..., usage_category=..., limit: Incomplete | None = ..., page_size: Incomplete | None = ...): ...
    def list(self, recurring=..., trigger_by=..., usage_category=..., limit: Incomplete | None = ..., page_size: Incomplete | None = ...): ...
    def page(self, recurring=..., trigger_by=..., usage_category=..., page_token=..., page_number=..., page_size=...): ...
