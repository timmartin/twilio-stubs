...
class TriggerList(ListResource):
    ...
    def create(self, callback_url: Any, trigger_value: Any, usage_category: Any, callback_method: Any = ..., friendly_name: Any = ..., recurring: Any = ..., trigger_by: Any = ...): ...
    def stream(self, recurring: Any = ..., trigger_by: Any = ..., usage_category: Any = ..., limit: Optional[Any] = ..., page_size: Optional[Any] = ...): ...
    def list(self, recurring: Any = ..., trigger_by: Any = ..., usage_category: Any = ..., limit: Optional[Any] = ..., page_size: Optional[Any] = ...): ...
    def page(self, recurring: Any = ..., trigger_by: Any = ..., usage_category: Any = ..., page_token: Any = ..., page_number: Any = ..., page_size: Any = ...): ...
...
class TriggerContext(InstanceContext):
    ...
    def fetch(self): ...
    def update(self, callback_method: Any = ..., callback_url: Any = ..., friendly_name: Any = ...): ...
    def delete(self): ...
