...
class ChallengeList(ListResource):
    ...
    def create(self, factor_sid: Any, expiration_date: Any = ..., details_message: Any = ..., details_fields: Any = ..., hidden_details: Any = ..., twilio_sandbox_mode: Any = ...): ...
    def stream(self, factor_sid: Any = ..., status: Any = ..., twilio_sandbox_mode: Any = ..., limit: Optional[Any] = ..., page_size: Optional[Any] = ...): ...
    def list(self, factor_sid: Any = ..., status: Any = ..., twilio_sandbox_mode: Any = ..., limit: Optional[Any] = ..., page_size: Optional[Any] = ...): ...
    def page(self, factor_sid: Any = ..., status: Any = ..., twilio_sandbox_mode: Any = ..., page_token: Any = ..., page_number: Any = ..., page_size: Any = ...): ...
...
class ChallengeContext(InstanceContext):
    ...
    def update(self, auth_payload: Any = ..., twilio_sandbox_mode: Any = ...): ...
