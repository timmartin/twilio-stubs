...
class ServiceList(ListResource):
    ...
    def create(self, friendly_name: Any = ..., webhook_url: Any = ..., reachability_webhooks_enabled: Any = ..., acl_enabled: Any = ..., reachability_debouncing_enabled: Any = ..., reachability_debouncing_window: Any = ..., webhooks_from_rest_enabled: Any = ...): ...
...
class ServiceContext(InstanceContext):
    ...
    def fetch(self): ...
    def delete(self): ...
    def update(self, webhook_url: Any = ..., friendly_name: Any = ..., reachability_webhooks_enabled: Any = ..., acl_enabled: Any = ..., reachability_debouncing_enabled: Any = ..., reachability_debouncing_window: Any = ..., webhooks_from_rest_enabled: Any = ...): ...
    @property
    def documents(self): ...
    @property
    def sync_lists(self): ...
