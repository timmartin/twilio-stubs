...
from twilio.rest.sync.v1.service.sync_stream.stream_message import StreamMessageList as StreamMessageList
from typing import Any, Optional

class SyncStreamList(ListResource):
    def __init__(self, version: Any, service_sid: Any) -> None: ...
    def create(self, unique_name: Any = ..., ttl: Any = ...): ...
